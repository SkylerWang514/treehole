// pages/command-by-me/command-by-me.js
var util = require('../command-by-me/util.js');
...
Page({
  ...
  async getMyCommentList(){
    const res = await request({url:"http://121.199.40.49:8443/comment/getMyComment",data:{uid:wx.getStorageSync("uid")},method: "GET"});
